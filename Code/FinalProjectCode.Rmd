...
gg_counties_pm <- ggplot() +
  ...
  labs(fill = "County") + 
  scale_fill_manual(name = "County", values = legend_colors) +
  ggtitle("Location of PM2.5 Monitors per County")+
...
gg_counties_ozone <- ggplot() +
  ...
  labs(fill = "County") + 
  scale_fill_manual(name = "County", values = legend_colors) +
  ggtitle("Location of Ozone Monitors Used per County")+
  theme(plot.title = element_text(size=12))
...
```{r Air Quality Data Visualizations, echo=FALSE, message=FALSE, warning=FALSE, fig.align='center', fig.cap="Ozone and PM 2.5 Visualiations"}
airquality_df <- read.csv(here("Data/Processed/CA_AQ_processed.csv"))
