...
Based on statistical models, we conclude the following:
A one ppm decrease in ozone concentration is associated with a 7367 unit increase in ED visits for asthma per 100k (p < 0.001). 

A one ug/m3 decrease in PM2.5 concentration is associated with a 27 unit increase in ED visits for asthma per 100k (p < 0.001).

A one unit increase in percent poverty is associated with a 19 unit increase in ED visits for asthma per 100k (p < 0.001). 
